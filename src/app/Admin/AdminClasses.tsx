...
import Layout from "../components/Layout"; // Bỏ dấu { }
import {
  Card,
  CardContent,
  CardDescription,
...
export default function AdminClasses() {
  ...
  const handleCreateClass = () => {
    ...
    try {
      ...
      const currentClasses = existingClasses
        ? JSON.parse(existingClasses)
        : classes;
  ...
  const handleAddStudents = () => {
    ...
    try {
      ...
      const currentClassStudents = existingData
      ...
      localStorage.setItem(
        "classStudents",
        JSON.stringify(updatedClassStudents),
      );
            ...
            >
              ...
              <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Nhập thông tin cho lớp học mới. Bạn có thể phân bổ giảng
                    viên và thêm sinh viên sau.
                  </DialogDescription>
                </DialogHeader>
                ...
                <CardHeader>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center gap-2 text-gray-600">
                      ...
                      <span
                        className={
                          !hasTeacher ? "text-orange-600 font-medium" : ""
                        }
                      >
                        {cls.instructor}
                      </span>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Button asChild className="w-full">
                      <Link to={`/admin/classes/${cls.id}`}>Xem chi tiết</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
              ...
              {selectedStudents.length > 0 && (
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-sm text-blue-900">
                    <strong>{selectedStudents.length}</strong> sinh viên đã được
                    chọn
                  </p>
                </div>
              )}
